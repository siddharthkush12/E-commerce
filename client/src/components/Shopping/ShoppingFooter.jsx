  ...
  return (
    <div className='border shadow flex flex-col items-center justify-center w-full bg-gradient-to-b from-orange-100 to-orange-200'>
      ...
      <div className='w-full flex flex-col gap-2 items-center justify-center pt-5'>
        <h4 className='text-xl md:text-4xl'>Subscribe to get Admin Access</h4>
        <span className='text-sm md:text-xs text-muted-foreground uppercase'>
          get admin access and add some products
        </span>
        <div className='my-2 md:my-9 flex items-center justify-center'>
          <form action='submit' className='relative w-full max-w-md '>
            <input
              type='text'
              className='bg-white w-full px-2 md:mx-10 py-3 rounded-full pr-32 shadow'
      ...
      <div className=' text-black w-full mt-5 md:py-10 flex flex-col md:flex-row justify-between px-10 relative'>
        ...
        <div className='flex flex-col text-lg md:text-lg md:items-center md:justify-center'>
          <div className='flex flex-col md:flex-row md:gap-10 gap-5 '>
            ...
            <div className='flex flex-col'>
              ...
              <ul className='space-y-1 text-sm md:text-lg text-muted-foreground'>
        ...
        <div className='flex flex-col max-w-md'>
          <div className='px-3 text-gray-800'>
            <h5 className='text-lg font-semibold mb-2 mt-6 md:mt-0 text-center'>About</h5>
