...
function Form({formControls, formData, setFormData, onSubmit, buttonText, isButtonDisabled, buttonStyleVariant,className}) {
  ...
  return (
    <form onSubmit={onSubmit}>
        ...
        <Button disabled={isButtonDisabled} type='submit' variant={buttonStyleVariant} className={`${className?className:'w-full'} mt-4 cursor-pointer`}>{buttonText || 'Submit'}</Button>
    </form>
  )
}
